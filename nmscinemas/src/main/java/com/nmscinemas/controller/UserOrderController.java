...
import com.nmscinemas.entities.CartItem;
import com.nmscinemas.entities.CartOrder;
...
import com.nmscinemas.services.UserOrderService;
...
public class UserOrderController {
	...
	public ResponseEntity<?> createOrder(@Valid @RequestBody CartOrder cartOrder){
		...
		for(CartItem item : cartItems) {
			Product product = this.productService.findMovie(item.getPid());
